...
const databaseApi = {
  ...
  dbRegisterInputCodes: dbFn('registerInputCodes'),
  ...
  dbCreateToolHistory: dbFn('createToolHistory'),
  dbGetToolHistories: dbFn('getToolHistories'),
  dbGetToolHistory: dbFn('getToolHistory'),
  dbRenameToolHistory: dbFn('renameToolHistory'),
  dbDeleteToolHistory: dbFn('deleteToolHistory'),
  ...
  dbGetGlobalRaindropRows: dbFn('getGlobalRaindropRows'),
  dbGetRaindropSyncLocalRows: dbFn('getRaindropSyncLocalRows'),
  dbApplyRaindropPullRecord: dbFn('applyRaindropPullRecord'),
  dbCompleteRemoteSyncTask: dbFn('completeRemoteSyncTask'),
  dbCompleteGlobalRaindropSync: dbFn('completeGlobalRaindropSync'),
  ...
  dbRemoveTelegramGroupSource: dbFn('removeTelegramGroupSource'),
...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  extractHaijiaoLinks: coreFn('toolbox', 'extractHaijiaoLinks'),
  ...
  getTelegramNetworkConfig: () => ipcRenderer.invoke('telegram:network-config'),
  saveTelegramNetworkConfig: options => ipcRenderer.invoke('telegram:network-save', options),
  testTelegramNetworkConfig: options => ipcRenderer.invoke('telegram:network-test', options),
  ...
  markTelegramGroupRead: options => ipcRenderer.invoke('telegram:mark-read', options),
  ...
  scanRaindropCollections: options => ipcRenderer.invoke('raindrop:scan-collections', options),
  scanRaindropAccount: () => ipcRenderer.invoke('raindrop:scan-account'),
  getRaindropItem: remoteId => ipcRenderer.invoke('raindrop:get-item', remoteId),
  ...
  normalizeRaindropSyncMode: coreFn('raindropSync', 'normalizeSyncMode'),
  normalizeRaindropComparableUrl: coreFn('raindropSync', 'normalizeComparableUrl'),
  extractRaindropRemoteCode: coreFn('raindropSync', 'extractRemoteCode'),
  buildRaindropRemotePayload: coreFn('raindropSync', 'remoteItemToPayload'),
  raindropRemoteItemHash: coreFn('raindropSync', 'remoteItemHash'),
  raindropLocalIdentity: coreFn('raindropSync', 'localItemIdentity'),
  classifyRaindropMirrorPair: coreFn('raindropSync', 'classifyMirrorPair'),
  ...
  parseInputEntries: coreFn('input', 'parseInputEntries'),
