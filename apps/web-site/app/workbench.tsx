...
import DatabaseBackupCenter from "./components/database-backup-center";
...
type DataTab = "records" | "history" | "library" | "migration" | "snapshots" | "backup";
